...
def parse_args():
    parser = argparse.ArgumentParser(
        description="MiniCPM-O-2_6 için yoga pozu sınıflandırma"
    )
...
def preprocess_image(image_path, input_size=448):
    """
    MiniCPM-O için görüntüyü ön işleme
    """
...
def main():
    ...
    model_name = model_path.split("/")[-1]  # MiniCPM-o-2_6

    # MiniCPM-O modelini yükle
    ...
    if args.input_file:
        ...
        for i, line in enumerate(lines):
            ...
            try:
                ...
                # MiniCPM-O modeli ile tahmin yap
